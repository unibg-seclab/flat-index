...
plot(baseline_curve, server_curves, "server-time-by-bandwidth.pdf")
plot(baseline_curve, total_curves, "overall-time-by-bandwidth.pdf")
baseline_worsening_curve = [(k, 1, float("NaN")) for k in sorted(server_time.keys())]
plot(baseline_worsening_curve, server_worsening_curves, "server-overhead-by-bandwidth.pdf", worsening=True)
plot(baseline_worsening_curve, total_worsening_curves, "overall-overhead-by-bandwidth.pdf", worsening=True)
